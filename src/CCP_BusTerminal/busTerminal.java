...
{
    Semaphore btSem=new Semaphore(10,true); //100 customers can be inside the terminal at a time
    ...
    public void enterTerminal(customer c)
    {
        ...
        try
        {
            ...
            Thread.sleep(10);
            System.out.println("Customer "+c.custID+" has entered the Bus Terminal (terminal population: "+(10-btSem.availablePermits())+")");
